...
used CSFTPAV6 as my rop source, extra mile wants me to use another dll

DLLS provided with tivoli
CSFTPAV6    -> 50500000 50577000     <- Could be a good choice, or better yet. mix & match
CSMTPAV6    -> 51000000 51032000     <- Could be a good choice, or better yet. mix & match
CSNCDAV6    -> 50200000 50237000     <- Could be a good choice, or better yet. mix & match
LIBCCLOG    -> 00c10000 00c3d000     <- bad
LIBMSG23    -> XXXXXXXX XXXXXXXX
SNCLIENTAPI -> 001c0000 001f3000     <- bad
SNFS        -> 10000000 1003d000     <- bad
